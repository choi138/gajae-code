...
| `CODEX_LB_API_KEY`              | codex-lb proxy auth                              | Using `codex-lb` provider preset                               | Key issued by the local codex-lb dashboard; sent as bearer auth to `http://127.0.0.1:2455/v1`       |
